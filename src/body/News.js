  ...
  render() {
    return (
      <div className="news">
        ...
        <img className="newsImage1" src="./Img/corona1.jpg"></img><br></br>
        ...
        <div className="news_box">
        <img className="newsImage1" src="./Img/corona2.jpg"></img><br></br>
